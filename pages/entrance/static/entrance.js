function checkCode (){
    //1000-1999 code: PC. 2000-2999: mobile.
    if (!validBrowser()){
        alert("Your browser is not supported. Please enter the experiment through another browser.");
    ...
    if (isnum == false){
        alert("Invalid Code"); //the code does not contain only digits
        document.getElementById('code_id').value="";
        return;
    }
...
// return true if the user entered from a mobile device
...
// check is the user entered from a mobile device or a tablet
...
function validBrowser() {
    ...
    if (isIE || isFirefox) //does not support firefox or internet explorer
        return false;
    return true;
}